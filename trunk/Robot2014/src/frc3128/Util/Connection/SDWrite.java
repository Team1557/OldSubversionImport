...
public class SDWrite {
     ...
     */
    public static void writeToDashboard(String name, double data) {SmartDashboard.putDouble(name, data);}
     ...
     */
    public static void writeToDashboard(String name, int data) {SmartDashboard.putDouble(name, data);}
